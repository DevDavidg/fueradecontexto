        ...
        <section className="py-8">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-5 text-lg leading-relaxed text-neutral-200">
              ¿Tienes alguna pregunta, sugerencia o quieres trabajar con
              nosotros? Estamos aquí para ayudarte. Completa el formulario y nos
              ...
              <div>
                ...
                <div className="space-y-3 text-neutral-300">
                  <div className="flex items-center gap-3">
                    ...
                    <p>fueradecontexto04@gmail.com</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <PhoneIcon className="w-5 h-5 text-fuchsia-500" />
                    <p>+54 9 11 61965319</p>
                  </div>
                  <div className="flex items-center gap-3">
