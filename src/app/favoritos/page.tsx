    ...
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
        <div className="max-w-lg mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Tu lista de favoritos está vacía
            </h1>
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed max-w-md mx-auto">
              ¡Es hora de descubrir productos increíbles! Haz clic en el corazón
              de cualquier producto para agregarlo a tus favoritos y encontrarlo
